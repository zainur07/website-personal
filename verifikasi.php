            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
						...
						$select =mysqli_query($koneksi, "UPDATE pengaduan set status='$status' where id_pengaduan=$id");
						if($select){
						 echo '<script>alert("Berhasil memverifikasi data.");</script>';
						 }else{
...
<?php
            $id = $_GET['id'];
            $select = mysqli_query($koneksi, "SELECT * FROM pengaduan WHERE id_pengaduan=$id") or die(sql_error($koneksi,_LINE_));
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        TANGGAPAN: <span class="text-muted"> untuk pengaduan dengan judul <?php print $data['judul']?></span>
      </div>
      <div class="card-body">
		...
		<option value="selesai">selesai</option>
		 ...
		 <button name="simpan" type="submit" class="btn btn-success btn-icon-split">
